...
<embed-code file="$examples/first-model/build.gradle.kts" start="plugins {" end="^}"></embed-code>
```kotlin
plugins {
    module
...
<embed-code file="$examples/first-model-with-framework/build.gradle.kts" start="plugins {" end="^}"></embed-code>
```kotlin
plugins {
    module
